...
class CNN(nn.Module):
    ...
    def __init__(self, channel_size):
        ...
        self.cnn = nn.Sequential(
            ...
            nn.Conv2d(128, 256, (3,3), (1,1), 1), nn.BatchNorm2d(256), nn.ReLU(True),
            nn.Conv2d(256, 256, (3,3), (1,1), 1), nn.ReLU(True), nn.MaxPool2d((2, 2), (2, 1), (0, 1)),
            nn.Conv2d(256, 512, (3,3), (1,1), 1), nn.BatchNorm2d(512), nn.ReLU(True),
            nn.Conv2d(512, 512, (3,3), (1,1), 1), nn.ReLU(True), nn.MaxPool2d((2, 2), (2, 1), (0, 1)),
            nn.Conv2d(512, 512, (2,2), (1,1), 0), nn.BatchNorm2d(512), nn.ReLU(True))
